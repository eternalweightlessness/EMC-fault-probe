...
"}")
        ...
        self.userInputTextEdit.setFocusPolicy(QtCore.Qt.StrongFocus)
...
"}")
        self.userInputTextEdit.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContents)
        self.userInputTextEdit.setObjectName("userInputTextEdit")
        self.horizontalLayout.addWidget(self.userInputTextEdit, 0, QtCore.Qt.AlignHCenter)
